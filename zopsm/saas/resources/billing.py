...
class BillingResource(SaasBase, ListCreateAPI):
    """
    ...
    def __repr__(self):
        return "Billing User Create & List"
...
class BillingSingleResource(SaasBase, RetrieveUpdateDeleteAPI):
    """
    ...
    def __repr__(self):
        return "Billing User Retrieve & Update & Delete"

    def resource_name(self):
        return "BillingSingleResource"

    @require_roles(roles=[ERoles.admin, ERoles.billing])
    def retrieve(self, params, meta, **kwargs):
        user = self.db.get_user(user_id=kwargs['billing_id'], account_id=kwargs['token']['account_id'])
    ...
    def update(self, params, meta, **kwargs):
        ...
        updated_user = self.db.update_user(user_id=kwargs['billing_id'], validated=kwargs['validated'],
    ...
    def delete(self, params, meta, **kwargs):
        self.db.delete_user(user_id=kwargs['billing_id'], account_id=kwargs['token']['account_id'])
        remove_user_tokens(kwargs['billing_id'])
